...
Start-Process -NoNewWindow -FilePath "python_server\venv\Scripts\python.exe" -ArgumentList "-m uvicorn main:app --host 0.0.0.0 --port 8000" -WorkingDirectory "python_server"
